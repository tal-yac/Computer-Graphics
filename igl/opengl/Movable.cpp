...
void Movable::MyRotate(const Eigen::Matrix3d &rot) { Tout.rotate(rot); }

void Movable::MyScale(Eigen::Vector3d amt) { Tin.scale(amt); }
...
// void Movable::TranslateInSystem(Eigen::Matrix4d Mat, Eigen::Vector3d amt,
// bool preRotation)
//{
//	Eigen::Vector3d v = Mat.transpose().block<3, 3>(0, 0) * amt; //transpose
//instead of inverse 	MyTranslate(v, preRotation);
// }
//
// void Movable::RotateInSystem(Eigen::Matrix4d Mat, Eigen::Vector3d rotAxis,
// double angle)
//{
//	Eigen::Vector3d v = Mat.transpose().block<3, 3>(0, 0) * rotAxis;
////transpose instead of inverse 	MyRotate(v.normalized(), angle);
// }
//
//
// void Movable::SetCenterOfRotation(Eigen::Vector3d amt)
